			...
			<div class="container-r">
				<div class="menu">
					<form action="Login" method="post">
						...
						<div class="check7">
							<span class="checkspan"><input type="checkbox" checked="checked" id="check7"><label for="check7"></label></span><span class="checktxt">Rember Me（7 Days）</span><span title="上一版本号：v1.1.4.180910" style="margin-left: 2px;cursor: pointer;">v1.2.0.180911</span>
						</div>
						<div class="sub-res">
