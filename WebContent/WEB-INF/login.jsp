			...
			<div class="container-r">
				<div class="menu">
					<form action="Login" method="post">
						...
						<div class="check7">
							<span class="checkspan"><input type="checkbox" checked="checked" id="check7"><label for="check7"></label></span><span class="checktxt">Rember Me（7 Days）</span><span title="上一版本号：v2.3.2.180925" style="margin-left: 2px;cursor: pointer;">v2.4.2.180926</span>
						</div>
						<div class="sub-res">
