...
<link rel="stylesheet" type="text/css" href="css/quantityWeight.css">
</head>
<body>
	<!-- 	头部开始 -->
		...
		<%@include file="nav.jsp"%>
			...
			<table border="1" cellspacing="0" cellspadding="0" id="table1">
				<tr>
				 ...
				 <c:forEach var="orderInfo" items="${quantityWeight}" varStatus="status">
	 	 ...
	 	 <c:choose>
				<c:when test="${queryType == 'common'}">
					<c:set var="queryUrl"
					value="QuantityWeight?type1=${classify1 }&searchContent1=${parameter1}&selected=${str}&currentPage=">
					</c:set>
				</c:when>
				<c:otherwise>
					<c:set var="queryUrl"
					value="GetQuantityWeightRoute?type1=${classify1 }&searchContent1=${parameter1}&type2=${classify2}&searchContent2=${parameter2}&selected=${str}&currentPage=">
					</c:set>
				</c:otherwise>
	...
	<div class="contract_add">
		<div class="contract_title">添加数量和重量证明信息</div>
		<div class="contractAdd_close">关闭</div>
		<div class="basic_info">
			<div class="table_title">数量和重量证明信息</div>
	...
	<div class="contract_update">
		<div class="contract_title">修改数量和重量证明信息</div>
    ...
    <!--数量和重量证明文档-->
    <div id="table_QuantityWeight">
    	<p class="f16 b m60b">CERTIFICATE OF QUANTITY AND WEIGHT</p>
    	<p class="m30b">Dear Sir/Madam</p>
    	<div class="content_text m30b">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; In accordance with the above captioned letter of credit (DC No.:<span contenteditable="true" class="DCNO"></span>) requirements, 
    		we hereby certify that the above captioned shipment was manufactured and tested in accordance with Cascade Microtech, Inc. standard procedures and the quality is equal to the requirements of Contract No.: 
    		<span contenteditable="true" class="ContractNO"></span>
    		<span style="text-decoration: none" class="PONOText"> and purchase order (PO No.: <span contenteditable="true" class="PONO"></span>)</span>.
    	</div>
    	<div class="content_text m30b">We also certify that the quantities and weights as specified in our shipping documents are correct.</div>
...
<script src="js/quantityWeight.js"></script>
