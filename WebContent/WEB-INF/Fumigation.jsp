...
<link rel="stylesheet" type="text/css" href="css/fumigation.css">
</head>
<body>
	<!-- 	头部开始 -->
		...
		<%@include file="nav.jsp"%>
			...
			<table border="1" cellspacing="0" cellspadding="0" id="table1">
				<tr>
				 ...
				 <c:forEach var="orderInfo" items="${fumigation}" varStatus="status">
	 	 ...
	 	 <c:choose>
				<c:when test="${queryType == 'common'}">
					<c:set var="queryUrl"
					value="Fumigation?type1=${classify1 }&searchContent1=${parameter1}&selected=${str}&currentPage=">
					</c:set>
				</c:when>
				<c:otherwise>
					<c:set var="queryUrl"
					value="GetFumigationRoute?type1=${classify1 }&searchContent1=${parameter1}&type2=${classify2}&searchContent2=${parameter2}&selected=${str}&currentPage=">
					</c:set>
				</c:otherwise>
	...
	<div class="contract_add">
		<div class="contract_title">添加熏蒸证明信息</div>
		<div class="contractAdd_close">关闭</div>
		<div class="basic_info">
			<div class="table_title">熏蒸证明信息</div>
	...
	<div class="contract_update">
		<div class="contract_title">修改熏蒸证明信息</div>
    ...
    <!--熏蒸证明文档-->
    <div id="table_Fumigation">
    	<p class="f16 b m60b">FUMIGATION CERTIFICATE</p>
    	<p class="m30b">Dear Sir/Madam</p>
    	<div class="content_text m30b">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Here we certified that the wooden crates in the shipment under this letter of credit 
    	(DC No.: <span contenteditable="true" class="DCNO">36100LC1700172 </span>) , contract (Contract No.: <span contenteditable="true" class="ContractNO">SACS-TD-1610-0250/REV.1</span>) 
    	<span style="text-decoration: none" class="PONOText"> and purchase order (PO No.: <span contenteditable="true" class="PONO"></span>)</span> have been treated by Heat Treatment (HT)
    	 or Methyl Bromide (MB) fumigation at the origin, and labeled with IPPC mark on each of the wooden cases in compliance with IPPC standard ISPM NO.15, 
    	 and a manually signed declaration of wooden cases labeled with IPPC mark in 3 original and 1 copy issued by manufacturer has been sent along with shipping documents.
    	</div>
    	<div class="content_text m30b">Yours faithfully</div>
...
<script src="js/fumigation.js"></script>
