...
function IsStandardProductPreview(){
	if($("span#StandardProduct_check").length && $("span#StandardProduct_check").text()=="是"){
		$(".m_table .t11").show();
		$(".m_table tbody td:nth-child(11)").show();
		// $(".m_table table td:nth-child(10)").css({"border-right":"1px solid #999"});
	}else{
		$(".m_table .t11").hide();
		$(".m_table tbody td:nth-child(11)").hide();
		// $(".m_table table td:nth-child(10)").css({"border-right":"0px solid #999"});
	}
}
