...
$('#fa-button3').on('click', function() {
	$(this).toggleClass('glyphicon-plus glyphicon-minus');
	$('#table1 tbody tr').find('td:eq(23)').toggle();
	$('#table1 tbody tr').find('td:eq(22)').toggle();
	$('#table1 tbody tr').find('td:eq(24)').toggle();
	$('#table1 tbody tr').find('td:eq(25)').toggle();
	$('#table1 thead tr').find('th:eq(22)').toggle();
	$('#table1 thead tr').find('th:eq(23)').toggle();
	$('#table1 thead tr').find('th:eq(24)').toggle();
	$('#table1 thead tr').find('th:eq(25)').toggle();
});
