...
public interface CertificateQaulityService {
	 ...
	 * @return
	 */
	public List<Map<String,Object>>  getCertificateQualityByClassifyInOne(String classify, Object parameter,Page page);
	/**
	 * 组合查询记录数
	 * @param classify1
	 * @param parameter1
	 ...
	 * @return
	 */
	public List<Map<String,Object>>  getCertificateQualityByClassifyInTwo(String classify1, Object parameter1,String classify2, Object parameter2,Page page);
