...
@WebServlet("/GetAcceptanceByPageTwo")
public class GetAcceptanceByPageTwoServlet extends HttpServlet{
	
	private static final long serialVersionUID = 1L;
	public GetAcceptanceByPageTwoServlet(){
		super();
	}
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("acceptance", service.getAcceptanceByClassifyInTwo(classify1, parameter1, classify2, parameter2, page));
