...
@WebServlet("/GetFumigationByPageTwo")
public class GetFumigationByPageTwoServlet extends HttpServlet{

	
	private static final long serialVersionUID = 1L;

	public GetFumigationByPageTwoServlet(){
		super();
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("fumigation", service.getFumigationByClassifyInTwo(classify1, parameter1, classify2, parameter2, page));
