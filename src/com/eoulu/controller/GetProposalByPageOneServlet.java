...
@WebServlet("/GetProposalByPageOne")
public class GetProposalByPageOneServlet extends HttpServlet{

	private static final long serialVersionUID = 1L;
	public GetProposalByPageOneServlet(){
		super();
	}
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("proposal", service.getInsuranceSlipByClassifyInOne(classify, parameter, page));
