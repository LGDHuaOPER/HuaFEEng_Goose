...
@WebServlet("/QuoteOtherRMBDelete")
public class QuoteOtherRMBDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public QuoteOtherRMBDeleteServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		boolean flag = service.deleteOtherRMBTemp(id);
		if (flag) {
			LogInfoService logs = new LogInfoServiceImpl();
			String JspInfo = "报价系统";
			String description = "删除-其他供应商RMB PO的商品信息"+id;
