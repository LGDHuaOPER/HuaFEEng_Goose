...
@WebServlet("/GetProposalByPageTwo")
public class GetProposalByPageTwoServlet extends HttpServlet{

	private static final long serialVersionUID = 1L;
	public GetProposalByPageTwoServlet(){
		super();
	}
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("proposal", service.getInsuranceSlipByClassifyInTwo(classify1, parameter1, classify2, parameter2, page));
		req.setAttribute("currentPage", page.getCurrentPage());
		req.setAttribute("proposalCounts", page.getRecordCounts());
		...
		req.getRequestDispatcher("WEB-INF\\Proposal.jsp").forward(req, resp);
	}
