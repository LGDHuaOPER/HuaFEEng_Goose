...
@WebServlet("/GetQuantityWeightByPageTwo")
public class GetQuantityWeightByPageTwoServlet extends HttpServlet{

	
	private static final long serialVersionUID = 1L;
	public GetQuantityWeightByPageTwoServlet(){
		super();
	}
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("quantityWeight", service.getQuantityWeightByClassifyInTwo(classify1, parameter1, classify2, parameter2, page));
